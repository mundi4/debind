...
Two extra targets you set the way you set your focus. Put *Set Custom Target 1* or *Set Custom Target 2* on a key, from the *Special* tab of *Add an Action*, then press that key with your cursor over a unit frame. Press it with your cursor over nothing to clear it.
