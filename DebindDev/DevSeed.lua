    ...
    return {
        ...
        shared = {
            ...
            GENERAL = {
                ...
                --- menu enables the frame-type boxes only while a unit frame condition is on
                --- (`ActionMenuNodes.lua`), and `GetBindingInfoForAction` drops them outright on a
                --- binding that has no such condition. `ignoreHoverUnit` is `dbver` 5's spelling of
                --- Cast as usual, and the ladder moves it into `casting`.
                ---
