...
local DEBIND_FILES = {
    ...
    "Solver.lua",
    "Misc.lua",
    "Conditions/Units.lua",
    "Conditions/Specs.lua",
    "Conditions/Known.lua",
    "ActionBindings.lua",
    "Issues.lua",
    "MacroText.lua",
    "ActionCatalog.lua",
...
local specs = {
    ...
    { name = "orderupgrade", path = root .. "/orderupgrade_spec.lua" },
    ...
    { name = "clickswitch", path = root .. "/clickswitch_spec.lua" },
