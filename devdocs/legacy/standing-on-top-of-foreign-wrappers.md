...
셋 안에 멈추고 그쪽 본문은 계속 도는 것. EUI 케이스 셋과 홀더 케이스 둘. 앞의 넷은
`frame:GetScript("OnEnter")(frame, true)`로 **진짜 래퍼 사슬을 돌린다** - 헤드리스가 못 보는 것은
...
- **커서가 실제로 프레임을 오가는 것.** 킷은 커서를 못 옮기므로 스크립트를 직접 부른다.
