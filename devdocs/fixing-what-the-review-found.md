...
> 상태: **넷 남았다.** 아래 1~4가 열려 있고 나머지는 닫혀서 여기서 지웠다. 2번은 다른 세션이
> 잡고 있다.
...
**1번으로 간다.** 같은 입력에 같은 답이 나오는데 네 번 짓는 것은 재볼 것 없이 낭비다. 재야 할
것은 얼마나 느린가가 아니라 **지금 저 넷이 서로를 부르는 순서**이고, 그건 재는 게 아니라 읽는
것이다.
