...
> 상태: 구현 들어감 (2026-09-23). 코드, 로케일, 테스트, `devdocs/`, README, CHANGELOG는 끝났고
> `npm run check`를 지난다. 남은 것은 도움말 두 페이지(`changelog.md`의 순서 절과 §6-1의
> `ordering.md`)다. 결정은 2026-09-23(소유자).
>
