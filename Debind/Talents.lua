...
--- (`devdocs/adding-a-talent-condition.md` §3).
---
...
---
--- **This specialization only** (`devdocs/adding-a-talent-condition.md` §5). Another one's nodes
...
--- configuration the character is standing in (`devdocs/adding-a-talent-condition.md` §6-1), so a
