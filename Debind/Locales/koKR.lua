...
L["PREFER_HOVER_UNIT_DESC"] = "개체창에 마우스를 올린 동안에는 그 개체창의 개체에게 행동을 사용합니다. 그 밖에서는 평소처럼, 지정한 대상에게 또는 지정이 없으면 현재 대상이나 자신에게 사용합니다. 마우스를 올렸는지는 행동이 누구에게 가는지만 정하고, 실행되는지는 정하지 않습니다. 개체창 위에서만 실행하려면 마우스 올림 조건을 써 주세요."
L["PREFER_HOVER_UNIT"] = "마우스 올린 개체에게 사용"
...
L["TYPE_EQUIPSLOT"] = "착용 칸"
L["TYPE_EQUIPSLOT_DESC"] = "이 칸에 착용 중인 것을 사용합니다."
L["TYPE_ITEM"] = "아이템"
L["TYPE_MACRO"] = "매크로"
