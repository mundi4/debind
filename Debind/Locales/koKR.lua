...
L["ORDER_FLAG_MISSING_MACRO"] = "없는 매크로"
...
L["ORDER_FLAG_UNDEFINED_STATE"] = "없는 상태 이름"
L["ORDER_FLAG_UNREACHABLE"] = "실행되지 않음"
L["ORDER_FLAG_OFFSPEC"] = "다른 전문화"
...
L["OVERVIEW"] = "개요"
-- 근거는 enUS 쪽 주석에.
L["OVERVIEW_DESC"] = "키가 지정된 모든 행동을 키별로 묶어서 보여줍니다. 한 키 안에서는 Debind가 훑는 순서대로 늘어놓습니다.|n|n다른 전문화의 행동도 같이 나옵니다. 그 전문화였다면 섰을 자리에 서고, 옆에 그렇게 적힙니다 - 그 전문화로 바꾸기 전까지는 어떤 키에도 안 걸립니다. 오른쪽에서 다른 탭을 열어도 이 목록은 바뀌지 않습니다.|n|n키가 없는 행동은 맨 끝에 모입니다. 문자열로 받아온 것은 같이 온 묶음 그대로 서고, 나머지는 이름순 한 덩어리입니다. 아직 받아들이지 않은 것도 목록에는 있지만, 받아들이기 전까지는 어떤 키에도 안 걸립니다."
...
L["ORDER_BLOCKED_SPEC"] = "옆 행동을 앞지를 수 없습니다 -- 둘은 전문화가 다르고, 한 번에 하나만 쓰이므로 둘 사이에는 정할 순서가 없습니다."
...
L["OVERVIEW_EMPTY_IMPORTED_ONLY"] = "이 캐릭터에 기다리고 있는 것이 없습니다. 다른 직업의 문자열이었다면 그 직업의 레이어에 들어가 있고, 그 직업으로 접속하면 보입니다."
-- 근거는 enUS 쪽 주석에.
...
L["IMPORT_FAILED_LIBS_MISSING"] = "Debind Share가 문자열을 읽는 라이브러리를 불러오지 못했습니다. Debind를 다시 받으면 됩니다."
L["PANEL_ADDON_MISSING"] = "이 기능에는 |cnHIGHLIGHT_FONT_COLOR:Debind Share|r가 필요한데 불러오지 못했습니다.|n|n꺼 두셨다면 애드온 목록에서 다시 켜 주세요. 목록에 아예 없다면 Debind를 다시 설치하면 함께 들어옵니다."
L["EXPORT_TITLE"] = "내보내기"
...
L["EXPORT_STRIP_KEYS"] = "단축키는 빼고"
L["IMPORT_STRIP_KEYS_DESC"] = "액션만 가져오고 걸려 있던 단축키는 뺍니다. 키는 직접 고르시면 됩니다.|n|n같이 있어야 뜻이 서는 것은 그대로 같이 옵니다. 조건으로 여러 액션에 쪼개진 키는 한 묶음으로 들어오고, 흩어진 조각이 아니라 그 묶음에 키를 겁니다."
L["EXPORT_STRIP_KEYS_DESC"] = "액션만 보내고 걸려 있는 단축키는 뺍니다. 받는 사람이 자기 키를 직접 고릅니다.|n|n같이 있어야 뜻이 서는 것은 그대로 같이 갑니다. 조건으로 여러 액션에 쪼개진 키는 한 묶음으로 도착하고, 받는 쪽은 흩어진 조각이 아니라 그 묶음에 키를 겁니다."
