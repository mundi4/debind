...
L["BINDING_ERROR_UNREACHABLE_OVER_FRAMES"] = "개체창 위에서는 이 행동이 실행되지 않습니다. 이 키의 다른 행동이 먼저 실행됩니다. 그 밖에서는 평소처럼 실행됩니다."
L["BINDING_ERROR_UNREACHABLE_OFF_FRAMES"] = "개체창 밖에서는 이 행동이 실행되지 않습니다. 이 키의 다른 행동이 먼저 실행됩니다. 개체창 위에서는 평소처럼 실행됩니다."
...
L["ORDER_FLAG_ISSUE_MINOR"] = "확인 필요"
