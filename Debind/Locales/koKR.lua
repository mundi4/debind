...
L["EXPORT_ADDON_MISSING"] = "공유 창은 Debind와 함께 들어 있는 |cnHIGHLIGHT_FONT_COLOR:Debind Share|r에 있는데 불러오지 못했습니다(%s). 애드온 목록에서 다시 켜거나 Debind를 다시 받으면 됩니다. 지정에는 아무 영향이 없습니다."
