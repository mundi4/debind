...
L["STATE_DRIVER_UPDATE_THROTTLE_DESC"] = "조건이 다시 계산되는 시간 간격입니다. 마우스가 무엇을 가리키는지처럼 일부 조건은 곧바로 갱신되지 않을 수 있습니다. 값이 낮을수록 자주 계산합니다 (|cnHIGHLIGHT_FONT_COLOR:0|r은 간격 없음).|n|n걱정하지 않아도 됩니다. 이 값은 영구히 저장되지 않고, 애드온을 비활성화하면 기본값으로 돌아갑니다.|n|n블리자드 기본값은 |cnHIGHLIGHT_FONT_COLOR:0.2|r초입니다."
