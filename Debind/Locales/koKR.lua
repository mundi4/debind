...
L["PREFER_HOVER_UNIT_DESC"] = "개체창에 마우스를 올린 동안에는 그 개체창의 개체에게 행동을 사용합니다. 그 밖에서는 위의 대상 그대로입니다. 마우스를 올렸는지는 행동이 누구에게 가는지만 정하고, 실행되는지는 정하지 않습니다. 개체창 위에서만 실행하려면 마우스 올림 조건을 써 주세요."
L["PREFER_HOVER_UNIT"] = "개체창 위에서는 그 개체를 우선"
L["PREFER_HOVER_UNIT_LOCKED_HOVER"] = "이 행동에는 마우스 올림 조건이 걸려 있어서, 개체창 위에서 무엇을 할지가 이미 정해져 있습니다."
L["PREFER_HOVER_UNIT_LOCKED_TARGET_HOVER"] = "이 행동은 이미 마우스 올린 개체창의 개체에게 나갑니다."
L["PREFER_HOVER_UNIT_LOCKED_TARGET_NONE"] = "이 행동은 실행할 때 대상을 새로 받으므로, 여기서 돌릴 겨눔이 없습니다."
...
L["UNIT_TANK"] = "방어 전담"
L["UNIT_TARGET"] = "대상"
L["UNITFRAME_CLICK_EDGE"] = "개체창을 클릭하면 시전하는 시점은"
L["UNITFRAME_CLICK_EDGE_DESC"] = "블리자드 개체창은 마우스 버튼을 뗄 때 시전합니다.|n|n게임 설정은 |cnHIGHLIGHT_FONT_COLOR:%s|r입니다. 단축키가 이미 따르고 있는 그 설정입니다."
L["UNITFRAME_CLICK_EDGE_DOWN"] = "누를 때"
L["UNITFRAME_CLICK_EDGE_GAME"] = "게임 설정과 같이"
