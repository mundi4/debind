...
L["PET"] = "소환수"
L["IMPORTANCE_DESC"] = "같은 키를 여러 행동에 지정할 수 있습니다. 키를 누르면 Debind가 순서대로 훑어서 조건이 맞는 첫 번째 것을 실행합니다 -- 언제나 하나만 실행됩니다.|n|n중요도를 가장 먼저 비교하므로, 중요도가 높으면 아래 것들을 모두 이깁니다. 중요도가 같은 행동끼리는 이 순서로 정해집니다:|n|n1. 조건. 조건이 있는 행동을 조건 없는 행동보다 먼저 봅니다.|n2. 탭. 더 좁은 탭을 먼저 봅니다. 지금 캐릭터와 전문화에서 시작해 공유까지 내려갑니다.|n3. 순서. 위가 모두 같으면 키에 추가한 행동이 맨 뒤에 섭니다. 행동을 옮길 수 있는 단계도 여기뿐입니다."
...
L["TYPE_BLOCK_DESC"] = "누르면 아무 일도 일어나지 않습니다. 키를 이 액션이 가져가므로 같은 키의 아래 액션도 돌지 않습니다.|n|n조건을 걸면 그 경우에만 아래 액션들을 멈춥니다."
...
-- 근거는 enUS 쪽 주석에.
L["IMPORT_DRAWER_EMPTY"] = "아직 아무것도 없습니다.|n|n만들거나 붙여넣은 것은 지울 때까지 여기 남아 있으니, 나중에 다시 와서 넣어도 됩니다."
-- "공유 코드" is the client's (`HOUSING_BLUEPRINT_COLLECTION_COPY`).
L["IMPORT_PASTE_TITLE"] = "공유 코드 붙여넣기"
L["IMPORT_PASTE_INPUT_LABEL"] = "가져올 텍스트"
L["IMPORT_PASTE_INSTRUCTIONS"] = "Debind나 Clique 공유 코드를 여기에 붙여넣으세요"
...
L["IMPORT_FAILED_NOT_OURS"] = "Debind나 Clique 공유 코드가 아닙니다."
L["IMPORT_FAILED_TOO_NEW"] = "더 새 버전의 Debind에서 만든 공유 코드입니다. 업데이트한 뒤 다시 해 보세요."
L["IMPORT_FAILED_TOO_OLD"] = "지금 버전이 읽기에는 너무 오래된 Debind에서 만든 공유 코드입니다.|n|n여기서 할 수 있는 일은 없습니다. 그 코드는 만들어진 버전에서는 그대로 쓸 수 있습니다."
L["IMPORT_FAILED_DAMAGED"] = "공유 코드를 읽지 못했습니다. 복사하다 뒷부분이 잘렸을 가능성이 큽니다. 전체를 다시 복사해서 붙여넣어 주세요."
L["IMPORT_FAILED_LIBS_MISSING"] = "Debind Storage가 공유 코드를 읽는 라이브러리를 불러오지 못했습니다. Debind를 다시 받으면 됩니다."
