...
L["SWITCH_LAYER_UNSET_GROUP"] = "아직 안 정한 자리"
...
L["SWITCH_ANSWER_MANUAL_DESC"] = "이 탭이나 스위치 바, 단축키로 직접 켜고 끕니다."
...
L["SWITCH_USAGE_EMPTY"] = "이 스위치를 부르는 곳이 없습니다."
...
L["SWITCH_DELETE_CONFIRM"] = "|cnHIGHLIGHT_FONT_COLOR:%1$s|r을(를) 이 계정 전체에서 지울까요?\n|cnHIGHLIGHT_FONT_COLOR:%2$d|r개의 행동이 이 이름을 부릅니다. 이름은 그대로 남아 빨간 줄이 되고, 같은 이름으로 다시 만들기 전까지 그 행동들은 눌러도 아무 일도 하지 않습니다."
L["SWITCH_DELETE_CONFIRM_OVERRIDES"] = "따로 정해 둔 자리 |cnHIGHLIGHT_FONT_COLOR:%d|r개도 같이 사라집니다. 다른 캐릭터에 있는 것까지입니다. 같은 이름으로 다시 만들어도 돌아오지 않습니다."
L["SWITCHES_EMPTY"] = "아직 만든 스위치가 없습니다.|n|n만들면 여기 서고, 고르면 그 스위치에 정해 둔 것이 오른쪽에 섭니다."
