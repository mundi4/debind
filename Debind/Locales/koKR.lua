...
L["LINE_TOOLTIP_INSTRUCTION_MESSAGE1"] = "왼쪽 클릭하면 이 행동을 선택하고 키를 지정합니다."
...
L["ORDER_LINE_TOOLTIP_INSTRUCTION_GOTO"] = "클릭하면 그 행동으로 옮겨 가서 편집합니다."
...
L["PRIORITY_SHARED_WARNING"] = "이 행동은 공유 범위에 있어서 중요도도 공유됩니다. 이 계정의 모든 캐릭터에서, 이 행동이 지정된 모든 키의 순서가 함께 바뀝니다. 다른 캐릭터에서 무슨 일이 일어나는지는 여기서 보여줄 수 없습니다 -- 이 창은 지금 접속한 캐릭터의 지정만 짓습니다."
L["OVERVIEW"] = "개요"
-- 근거는 enUS 쪽 주석에.
...
L["TARGET_UNIT"] = "대상"
--- 통에 줄이 둘 이상 보이는 순간 뜨는 도움말 풍선. 근거는 enUS 쪽 주석에.
--- 세 낱말(옮기기, 복사, 삭제)이 벌크 메뉴의 항목 이름과 같아야 한다.
L["TIP_MULTI_SELECT"] = "CTRL이나 SHIFT를 누른 채 클릭하면 행동을 여러 개 고를 수 있고, 고른 것을 한꺼번에 옮기거나 복사하거나 삭제할 수 있습니다."
