...
L["CONDITION_ADVFLYABLE_NO"] = "하늘비행이 안 되는 곳에서"
L["CONDITION_ADVFLYABLE_YES"] = "하늘비행이 되는 곳에서"
L["CONDITION_ADVFLYABLE"] = "하늘비행 가능"
...
L["CONDITION_CUSTOM_STATES"] = "스위치"
L["CONDITION_CUSTOM_STATE_NO"] = "스위치가 꺼져 있을 때"
L["CONDITION_CUSTOM_STATE_YES"] = "스위치가 켜져 있을 때"
L["CONDITION_EXTRABAR_NO"] = "기타 행동 버튼이 없을 때"
L["CONDITION_EXTRABAR_YES"] = "기타 행동 버튼이 있을 때"
L["CONDITION_EXTRABAR"] = "기타 행동 버튼"
L["CONDITION_FLYABLE_NO"] = "비행이 안 되는 곳에서"
L["CONDITION_FLYABLE_YES"] = "비행이 되는 곳에서"
L["CONDITION_FLYABLE"] = "비행 가능"
L["CONDITION_FLYING_NO"] = "떠 있지 않을 때"
L["CONDITION_FLYING_YES"] = "떠 있을 때"
L["CONDITION_FLYING"] = "공중"
L["CONDITION_FRAMETYPES"] = "개체창 종류"
L["CONDITION_FRAMETYPES_DESC"] = "종류가 있는 것은 가리키고 있는 개체창뿐입니다. 이 개체가 그 개체창의 개체가 아닐 때는 이 조건이 막지 않습니다."
L["CONDITION_GROUP"] = "그룹"
L["CONDITION_INDOORS_NO"] = "실내가 아닐 때"
L["CONDITION_INDOORS_YES"] = "실내에 있을 때"
L["CONDITION_INDOORS"] = "실내"
...
L["CONDITION_TALENT"] = "특성"
L["CONDITION_TALENT_TAKEN"] = "찍었을 때만"
L["CONDITION_TALENT_NOT_TAKEN"] = "안 찍었을 때만"
L["CONDITION_TALENT_HERO"] = "영웅 특성: %s"
L["CONDITION_TALENT_VALUE_TAKEN"] = "%s을(를) 찍었을 때만"
L["CONDITION_TALENT_VALUE_NOT_TAKEN"] = "%s을(를) 안 찍었을 때만"
L["CONDITION_MOUNTED_NO"] = "탈것을 타지 않았을 때"
L["CONDITION_MOUNTED_YES"] = "탈것을 탔을 때"
L["CONDITION_MOUNTED"] = "탈것"
...
L["CONDITION_ROLE"] = "역할"
L["CONDITION_ROLE_DESC"] = "역할을 알 수 있는 것은 파티/공격대 개체창뿐입니다. 다른 개체창에서나, 이 개체가 가리키고 있는 개체창의 개체가 아닐 때는 이 조건이 막지 않습니다."
L["ROLE_TANK"] = "방어 전담"
L["ROLE_HEALER"] = "치유 전담"
...
L["CONDITION_SPEC"] = "직업/전문화"
L["LINE_TOOLTIP_SPEC_OVERFLOW"] = "%s 외"
L["CONDITION_SPEC_DESC"] = "이 행동이 발동할 전문화를 고릅니다. 모든 직업이 나오는 것은 이 행동을 다른 직업 캐릭터와 함께 쓸 수 있기 때문입니다."
...
L["CONDITION_LIFE"] = "생사"
L["CONDITION_UNIT_GROUP"] = "소속"
L["CONDITION_UNITS"] = "개체"
L["CONFIRM_CURRENT_CHANGE_FIRST"] = "지금 변경 사항을 먼저 확정하십시오."
L["CONVERT_TO_MACRO_TEXT"] = "사용자 지정 매크로로 변환"
L["COPY_TO"] = "복사할 곳..."
-- 근거는 enUS 쪽 주석에.
L["CURRENT_TAB_SUFFIX"] = "%s |cnLIGHTGRAY_FONT_COLOR:(현재)|r"
L["CUSTOM_STATE_EDIT_VALUE_DESC"] = "조건문이 맞으면 스위치가 켜지고 아니면 꺼집니다. 이 스위치를 쓰는 키를 누를 때마다 확인합니다.|n|n예: |cnHIGHLIGHT_FONT_COLOR:[combat,nostealth]|r 또는 |cnHIGHLIGHT_FONT_COLOR:[@tank,exists][combat]|r|n|n여기서는 |cnHIGHLIGHT_FONT_COLOR:@@|r(골뱅이 두 개)를 쓸 수 없습니다. 스위치는 누름이 대상을 정하기 전에 계산되므로 가리킬 대상이 없습니다."
L["CUSTOM_STATE_MODE_MACRO_CONDITIONAL_DESC"] = "적어 둔 매크로 조건문을 보고 애드온이 켜고 끕니다 (예: |cnHIGHLIGHT_FONT_COLOR:[@healer,exists]|r)."
...
-- 근거는 enUS 쪽 주석에.
L["CUSTOM_TARGET_FRAME_NOT_OURS_IN_COMBAT"] = "|cnHIGHLIGHT_FONT_COLOR:다른 애드온|r|cnRED_FONT_COLOR:이 이 개체창을 몰고 있어서, 전투 중에는 여기서 사용자 지정 대상을 지정할 수 없습니다|r"
L["CUSTOM_TARGET_UNSUPPORTED_UNIT_IN_COMBAT"] = "|cnRED_FONT_COLOR:전투 중에는 플레이어, 소환수, 파티/공격대, 우두머리, 투기장 개체창에서만 사용자 지정 대상을 지정할 수 있습니다|r"
L["CUSTOM_TARGET_UNSUPPORTED_UNIT"] = "|cnRED_FONT_COLOR:사용자 지정 대상으로는 자신, 자신의 소환수, 파티나 공격대의 사람, 전투의 우두머리, 투기장 상대만 담을 수 있습니다|r"
L["DEFAULT"] = "기본값"
...
-- 같은 축의 반대쪽. 「이 그룹」이라고 안 쓴 이유와 한 벌이 흩어진다는 말이 여기 없는 이유는
-- enUS 쪽 주석에.
L["KEY_HEADER_UNBIND"] = "키 설정 해제"
L["KEY_HEADER_UNBIND_DESC"] = "이 머리글 아래의 행동 전부에서 단축키를 뗍니다. 접어놨든 몇 개가 들었든 전부입니다."
...
L["LAYER_DESC_SHARED_CLASS"] = "계정 내 모든 %1$s용. 중요도가 같다면 여기 있는 키가 %2$s의 같은 키보다 우선합니다."
-- 조사가 직업명 받침을 타므로 "(가)"를 붙인다(사냥꾼이 / 드루이드가). DELETE_CONFIRM_MESSAGE의
-- "을(를)"과 같은 방식이다.
L["LAYER_DESC_SHARED_SPEC"] = "계정 내 모든 %1$s이(가) %2$s일 때. 중요도가 같다면 여기 있는 키가 %3$s의 같은 키보다 우선합니다."
L["LAYER_DESC_CHARACTER_GENERAL"] = "이 캐릭터 전용. 중요도가 같다면 여기 있는 키가 공유 전체의 같은 키보다 우선합니다."
-- 영어는 인자가 하나도 없고(툴팁 제목이 전문화를 이미 보여준다) 여기는 전문화명 하나를 받는다.
-- 근거는 enUS 쪽 주석에.
L["LAYER_DESC_CHARACTER_SPEC"] = "이 캐릭터가 %s일 때. 중요도가 같다면 여기 있는 키가 다른 모든 탭의 같은 키보다 우선합니다."
...
-- 근거는 enUS 쪽 주석에.
L["MACROFRAME_CANCEL_DESC"] = "이 행동을 사용자 지정 매크로가 되기 전으로 되돌립니다. 여기 입력한 내용은 사라집니다."
L["MACROFRAME_CHAR_LIMIT"] = "%1$d/%2$d자 사용"
-- 근거는 enUS 쪽 주석에.
L["MACROFRAME_REVERT"] = "되돌리기"
L["MOVE_TO"] = "옮길 곳..."
L["MOVE_TO_CURRENT_LAYER_BLOCKED"] = "이미 이 레이어에 있습니다."
L["NO_ACTIONS_IN_THIS_LAYER"] = "이 레이어에는 행동이 없습니다. 주문, 매크로, 아이템, 탈것을 여기로 끌어다 놓으면 새 행동이 추가됩니다."
-- 근거는 enUS 쪽 주석에.
...
L["PET"] = "소환수"
L["IMPORTANCE_DESC"] = "같은 키를 여러 행동에 지정할 수 있습니다. 키를 누르면 Debind가 순서대로 훑어서 조건이 맞는 첫 번째 것을 실행합니다 -- 언제나 하나만 실행됩니다.|n|n중요도를 가장 먼저 비교하므로, 중요도가 높으면 아래 것들을 모두 이깁니다. 중요도가 같은 행동끼리는 이 순서로 정해집니다:|n|n1. 탭. 더 좁은 탭을 먼저 봅니다. 지금 캐릭터와 전문화에서 시작해 공유까지 내려갑니다.|n2. 순서. 같은 탭 안에서는 키에 추가한 행동이 맨 뒤에 섭니다. 먼저 실행과 나중에 실행으로 옮기며, 행동을 옮길 수 있는 단계도 여기뿐입니다."
-- 끝의 이유절에 주어를 세웠다("불러와지지 않았습니다" -> "Debind는 ...만 불러옵니다").
-- 근거는 enUS 쪽 주석에.
L["IMPORTANCE_SHARED_WARNING"] = "이 행동은 공유 범위에 있어서 중요도도 공유됩니다. 이 계정의 모든 캐릭터에서, 이 행동이 지정된 모든 키의 순서가 함께 바뀝니다. 다른 캐릭터에서 무슨 일이 일어나는지는 여기서 보여줄 수 없습니다 -- Debind는 지금 접속한 캐릭터의 지정만 불러옵니다."
L["OVERVIEW"] = "개요"
-- 근거는 enUS 쪽 주석에.
...
-- 위 넷과 틀이 다르다. 막는 것이 아니라 겨룰 일이 없는 것이라 바꿀 축도 없다. 근거는 enUS
-- 쪽 주석에.
L["ORDER_BLOCKED_SPEC"] = "이 행동과 옆 행동은 같이 활성화되는 일이 없어서, 둘의 순서는 아무것도 정하지 않습니다."
...
L["SPELL_PICKER_GROUP_INVENTORY"] = "소지품"
L["SPELL_PICKER_GROUP_EQUIPPED"] = "착용한 것 사용"
L["SPELL_PICKER_GROUP_FAVORITE_MOUNTS"] = "즐겨찾는 탈것"
L["SPELL_PICKER_GROUP_FAVORITE_TOYS"] = "즐겨찾는 장난감"
...
L["SPELL_PICKER_RIGHT_CLICK_TO_ADD"] = "오른쪽 클릭하면 다른 레이어에 추가할 수 있습니다."
L["SPELL_PICKER_LEFT_CLICK_TO_REPLACE"] = "왼쪽 클릭하면 이것으로 바뀝니다."
L["SPELL_PICKER_REPLACE_TITLE"] = "행동 바꾸기"
L["SPELL_PICKER_SHOW_OFFSPEC"] = "비활성 전문화"
L["SPELL_PICKER_TAB_COLLECTIBLE"] = "수집품"
L["SPELL_PICKER_TAB_COMMAND"] = "명령"
L["SPELL_PICKER_TAB_ITEM"] = "아이템"
...
L["STATE_DRIVER_UPDATE_THROTTLE"] = "조건 갱신 주기"
L["STATE_DRIVER_UPDATE_THROTTLE_DESC"] = "블리자드 상태 드라이버가 도는 시간 간격입니다. 단축키는 누르는 순간에 조건을 계산하므로 키가 답하는 속도는 이 값과 상관이 없고, 이 값을 기다리는 것은 차량이나 애완동물 대전이 행동 단축바를 가져간 것을 게임이 알아차리는 쪽입니다. 값이 낮을수록 자주 돕니다 (|cnHIGHLIGHT_FONT_COLOR:0|r은 간격 없음).|n|n걱정하지 않아도 됩니다. 이 값은 영구히 저장되지 않고, 애드온을 비활성화하면 기본값으로 돌아갑니다.|n|n블리자드 기본값은 |cnHIGHLIGHT_FONT_COLOR:0.2|r초입니다."
L["STATE_DRIVER_UPDATE_THROTTLE_WARNING"] = "이 값을 바꾸면 성능 문제가 생길 수 있습니다."
L["SWITCH_ANSWER_ON"] = "켜짐"
L["SWITCH_ANSWER_ON_DESC"] = "접속할 때와 전문화를 바꿀 때 켜집니다. 그 사이에는 직접 끌 수 있습니다."
L["SWITCH_ANSWER_OFF"] = "꺼짐"
L["SWITCH_ANSWER_OFF_DESC"] = "접속할 때와 전문화를 바꿀 때 꺼집니다. 그 사이에는 직접 켤 수 있습니다."
L["SWITCH_ANSWER_REMEMBER"] = "두던 대로"
L["SWITCH_ANSWER_REMEMBER_DESC"] = "접속할 때와 전문화를 바꿀 때 두고 나간 그대로 돌아옵니다. 캐릭터마다 따로 기억합니다."
L["SWITCH_LAYER_PICKER"] = "정할 자리"
L["SWITCH_OVERRIDE_DESC"] = "이 스위치가 한 직업, 한 전문화, 한 캐릭터에서 어떻게 시작할지 따로 정합니다. 아무것도 정하지 않은 자리는 계정 전체 답을 씁니다."
L["SWITCH_OVERRIDE_NEW"] = "%s |cnPURE_GREEN_COLOR:다른 자리에도 정하기|r"
L["SWITCH_OVERRIDE_REMOVE_CONFIRM"] = "|cnNORMAL_FONT_COLOR:%1$s|r에서 |cnNORMAL_FONT_COLOR:%2$s|r에 정해둔 것을 지울까요?"
L["SWITCH_MODE_LABEL"] = "여기서 작동하는 방식"
L["SWITCH_ANSWER_IGNORE"] = "무시함"
L["SWITCH_ANSWER_IGNORE_DESC"] = "이 스위치를 쓰는 액션이 스위치가 켜졌든 꺼졌든 작동합니다."
L["SWITCH_EXPR_LABEL"] = "매크로 조건문"
L["SWITCH_IGNORED"] = "여기서는 무시함"
L["SWITCH_OVERRIDE_REMOVE"] = "이 자리에 정한 것 지우기"
L["SWITCH_OVERRIDE_REMOVE_DESC"] = "여기 적어 둔 시작 값과 계산식도 같이 사라지고, 한 단계 넓은 자리가 대신 답합니다."
L["SWITCH_ANSWER_MANUAL"] = "직접 지정"
L["SWITCH_ANSWER_MANUAL_DESC"] = "단축키로 직접 켜고 끕니다."
L["SWITCH_START_VALUE"] = "시작 값"
L["SWITCH_TAB_SETTINGS"] = "설정"
L["SWITCH_TAB_USAGE"] = "쓰는 곳"
L["SWITCH_USAGE_HERE"] = "현재 캐릭터"
L["SWITCH_USAGE_ACCOUNT"] = "계정 전체"
L["SWITCH_USAGE_EXPRS"] = "다른 스위치"
L["SWITCH_USAGE_ACTIONS"] = "액션"
L["SWITCH_USAGE_OPENABLE"] = "이 캐릭터에서 열 수 있습니다."
L["SWITCH_USAGE_LOG_IN"] = "거기로 접속해야 바꿀 수 있습니다."
L["SWITCH_USAGE_GOTO"] = "누르면 이 액션으로 갑니다."
L["SWITCH_USAGE_EMPTY"] = "이 스위치를 쓰는 곳이 없습니다."
L["SWITCHES_DETAIL_EMPTY"] = "스위치를 고르십시오."
L["SWITCH_TURN_ON"] = "켜기"
L["SWITCH_TURN_OFF"] = "끄기"
L["SWITCH_AUTOMATIC"] = "자동으로 업데이트됨"
L["SWITCH_TOGGLE_INSTRUCTION"] = "누르면 켜고 끕니다."
L["SWITCH_TOGGLE_IN_COMBAT"] = "전투 중에는 여기서 못 바꿉니다. 스위치를 켜고 끄는 단축키는 언제든 됩니다."
L["ORDER_MOVED_BUTTON"] = "실행 순서 변경됨"
L["ORDER_MOVED_POPUP"] = "Debind는 조건이 있는 행동을 조건 없는 행동보다 먼저 봤습니다. 이제는 그러지 않습니다. 중요도 다음은 탭이고, 그 다음이 직접 정한 순서입니다.|n|n이 캐릭터에서 순서가 바뀐 키: %d개|n|n개요 목록에 표시해 두었고, 목록 위 거르기에서 표시가 있는 키만 볼 수 있습니다. 다른 캐릭터는 그 캐릭터에서 따로 봐야 합니다.|n|n이 알림과 표시는 이 캐릭터에서 다시 뜨지 않습니다."
L["ORDER_MOVED_POPUP_SEEN"] = "확인했습니다"
L["ORDER_MOVED_GROUP"] = "이 키의 순서가 이번 업데이트에서 바뀌었습니다."
L["FILTER_MARKED"] = "표시가 있는 키"
L["FILTER_UNMARKED"] = "표시가 없는 키"
L["LEGACY_ORDER"] = "예전 실행 순서 사용"
L["LEGACY_ORDER_DESC"] = "조건이 있는 행동을 조건 없는 행동보다 먼저 보도록 되돌립니다. 실행 순서에서 그 밖에 달라진 것은 돌아오지 않습니다.|n|n이 옵션은 다음 업데이트에서 없어지며, 그 뒤로는 모두가 새 순서를 씁니다."
L["SWITCH_MESSAGES"] = "스위치 변경 메시지"
L["SWITCH_MESSAGES_DESC"] = "스위치가 바뀌면 대화창에 한 줄 적습니다. 직접 켜고 끄는 스위치만 적고, 매크로 조건문으로 애드온이 값을 정하는 스위치는 적지 않습니다."
...
L["GIVE_BACK_ONLY_WITH_ACTION_DESC"] = "대신 선 단축바의 그 자리에 실제로 무언가 들어 있을 때만 키를 돌려줍니다. 빈 버튼의 키는 걸어 둔 액션을 그대로 씁니다."
L["GIVE_BACK_PET_BATTLE_DESC"] = "애완동물 대전 동안 행동 단축키 1번부터 5번까지에 걸린 키를 게임에 돌려줍니다. 대전 기술은 키로 닿을 다른 길이 없습니다."
L["GIVE_BACK_HOUSE_EDITOR"] = "집 편집기"
L["GIVE_BACK_HOUSE_EDITOR_DESC"] = "집 편집기는 열려 있는 동안 몇몇 키를 자기 것으로 가져갑니다. 켜면 그 키에서만 Debind가 물러나고 나머지 키는 그대로 씁니다."
...
L["SWITCH_CREATE"] = "새 스위치..."
L["SWITCH_CREATE_BUTTON"] = "새 스위치"
L["SWITCH_CREATE_BUTTON_INSTRUCTION"] = "누르면 이름을 묻습니다."
L["SWITCH_CREATE_DESC"] = "스위치를 만들어서 이 행동에 바로 겁니다."
L["SWITCH_CREATE_PROMPT"] = "새 스위치를 뭐라고 부를까요?\n영문자, 숫자, |cnHIGHLIGHT_FONT_COLOR:_|r만 쓸 수 있어요. 앞의 |cnHIGHLIGHT_FONT_COLOR:$|r는 저절로 붙어요."
L["SWITCH_NAME_ERROR_INVALID"] = "스위치 이름에는 영문자, 숫자, |cnHIGHLIGHT_FONT_COLOR:_|r만 쓸 수 있어요."
L["SWITCH_NAME_ERROR_TAKEN"] = "같은 이름의 스위치가 이미 있습니다."
L["SWITCH_ACTION_TITLE"] = "이 키를 누르면"
L["SWITCH_ACTION_ON"] = "켭니다"
L["SWITCH_ACTION_OFF"] = "끕니다"
L["SWITCH_ACTION_TOGGLE"] = "뒤집습니다"
L["SWITCH_DELETE_CONFIRM"] = "|cnNORMAL_FONT_COLOR:%s|r을(를) 이 계정 전체에서 지울까요?"
...
L["TAB_DESC_CHARACTER"] = "이 캐릭터만 사용합니다. 중요도가 같다면 여기 있는 키가 공유의 같은 키보다 우선합니다."
...
L["TYPE_BLOCK_DESC"] = "누르면 아무 일도 일어나지 않습니다. 키를 이 액션이 가져가므로 같은 키의 아래 액션도 돌지 않습니다.|n|n조건을 걸면 그 경우에만 아래 액션들을 멈춥니다. 키에 추가한 액션은 맨 뒤에 서므로, 멈출 액션들 위로 올리려면 먼저 실행을 쓰세요."
L["TYPE_COMMAND"] = "단축키 명령"
L["TYPE_FLYOUT"] = "플라이아웃"
L["TYPE_FOCUS"] = "주시 대상 설정"
L["USESLOT_NUMBERED"] = "%s %d"
L["TYPE_USESLOT"] = "착용 칸"
L["TYPE_USESLOT_DESC"] = "이 칸에 착용 중인 것을 사용합니다."
L["TYPE_ITEM"] = "아이템"
L["TYPE_MACRO"] = "매크로"
L["TYPE_MACROTEXT_DESC"] = "이 애드온 안에 사는 매크로를 만들어서, 와우의 매크로 칸은 그대로 비워 둡니다. 와우 매크로 목록에 있는 매크로와 달리 특수 개체를 겨냥하고 스위치를 읽을 수 있습니다.|n|n예: |cnHIGHLIGHT_FONT_COLOR:/cast [@tank,exists] 회복|r"
...
L["TYPE_SETSTATE_DESC"] = "스위치를 켜거나 끕니다. 스위치는 다른 행동이 조건으로 삼는 내가 만든 켜짐/꺼짐 값이라, 켜져 있을 때와 꺼져 있을 때 키 하나가 서로 다른 일을 하게 됩니다.|n|n추가한 뒤 오른쪽 클릭하면 어느 스위치를 다룰지, 그 스위치를 켤지 끌지 전환할지 고를 수 있습니다.|n|n|cnHIGHLIGHT_FONT_COLOR:전투 중|r에도 됩니다."
L["TYPE_SETSTATE_ANY"] = "스위치"
L["TYPE_SETSTATE_OFF"] = "%s 끄기"
L["TYPE_SETSTATE_ON"] = "%s 켜기"
L["TYPE_SETSTATE_TOGGLE"] = "%s 전환"
L["TYPE_SETSTATE"] = "스위치"
L["TYPE_SPELL"] = "주문"
L["TYPE_TARGET"] = "대상 선택"
...
L["UNIT_TANK"] = "방어 전담"
L["UNIT_TARGET"] = "대상"
L["UNITFRAME_CLICK_EDGE"] = "클릭 시점"
L["UNITFRAME_CLICK_EDGE_DESC"] = "개체창을 클릭했을 때 시전하는 시점입니다. 마우스 버튼을 누를 때와 뗄 때 중에서 고릅니다."
L["UNITFRAME_CLICK_EDGE_DOWN"] = "누를 때"
L["UNITFRAME_CLICK_EDGE_GAME"] = "게임 설정"
...
L["APPROVE_ALL_IMPORT_DESC"] = "아직 기다리고 있는 것을 어디에 있든 전부 받습니다. 지금 전문화가 아닌 곳에 내려앉은 것까지 포함합니다. 다만 받는 것만으로는 아무것도 동작하지 않습니다. 들어온 것에는 단축키가 없어서 목록 맨 아래에 모이고, 거기서 지정해야 그때부터 동작합니다."
...
L["MOVE_BLOCKED_IMPORTED"] = "아직 받아들이지 않은 것입니다. 받아들이는 것이 먼저입니다."
L["MENU_BLOCKED_ONLY_ONE"] = "한 번에 하나만 바꿀 수 있습니다. 하나만 골라 주세요."
L["MENU_BLOCKED_SOME_CANNOT"] = "고른 것 중에 이것을 가질 수 없는 것이 섞여 있습니다. 그 행을 선택에서 빼면 됩니다."
L["REJECT_IMPORT"] = "버리기"
...
L["REPLACE_ACTION"] = "바꾸기..."
L["REPLACE_CONFIRM_ONE"] = "이 행동을 |cnHIGHLIGHT_FONT_COLOR:%s|r(으)로 바꿀까요?"
L["REPLACE_CONFIRM_MANY"] = "행동 |cnHIGHLIGHT_FONT_COLOR:%d|r개를 |cnHIGHLIGHT_FONT_COLOR:%s|r(으)로 바꿀까요?"
L["REPLACE_CONFIRM_LOSES"] = "다음의 설정이 사라집니다:"
L["REPLACE_CONFIRM_MACROTEXT"] = "사용자 지정 매크로의 본문은 남지 않습니다."
...
L["STORAGE_DELETE_ACTION"] = "이 행동 삭제"
L["STORAGE_DELETE_SELECTED"] = "선택한 %d개 삭제"
L["STORAGE_DELETE_SELECTED_CONFIRM"] = "여기서 행동 %1$d개를 빼낼까요? 되돌릴 수 없어서 다시 만들어야 해요."
L["STORAGE_PREVIEW_ELSEWHERE"] = "둘 자리가 없는 것"
L["STORAGE_TITLE"] = "창고"
L["STORAGE_MENU_DESC"] = "설정을 따로 담아 둡니다. 이 캐릭터에서 만든 것도, 남에게 받아 붙여넣은 것도요.|n|n여기 있는 것은 아무것도 켜져 있지 않아요. 넣으면 그 안의 행동이 꺼진 채로 들어오니까, 받아들이기 전까지는 무엇을 눌러도 달라지지 않아요."
...
L["IMPORT_ENTRY_COUNTS"] = "키 %1$d개, 행동 %2$d개"
...
L["EXPORT_SELECTED_COUNT"] = "%2$d개 중 %1$d개 선택됨"
