...
L["SWITCH_USED_ACCOUNT"] = "계정 전체: |cnHIGHLIGHT_FONT_COLOR:%d|r"
L["SWITCH_USED_CHARACTER"] = "현재 캐릭터: |cnHIGHLIGHT_FONT_COLOR:%d|r"
L["SWITCH_USED_LIVE"] = "현재 활성: |cnHIGHLIGHT_FONT_COLOR:%d|r"
...
L["SWITCH_RENAME_PROMPT"] = "이 스위치를 뭐라고 부를까요?\n이름은 |cnHIGHLIGHT_FONT_COLOR:$|r로 시작하고 영문자, 숫자, |cnHIGHLIGHT_FONT_COLOR:_|r만 쓸 수 있어요."
...
L["SWITCH_NAME_ERROR_INVALID"] = "스위치 이름은 |cnHIGHLIGHT_FONT_COLOR:$|r로 시작하고 영문자, 숫자, |cnHIGHLIGHT_FONT_COLOR:_|r만 쓸 수 있습니다."
...
L["TYPE_SETSTATE_DESC"] = "스위치를 켜거나 끕니다. 스위치는 다른 행동이 조건으로 삼는 내가 만든 켜짐/꺼짐 값이라, 켜져 있을 때와 꺼져 있을 때 키 하나가 서로 다른 일을 하게 됩니다.|n|n와우가 단축키 변경을 막는 |cnHIGHLIGHT_FONT_COLOR:전투 중|r에도 전환됩니다."
L["TYPE_SETSTATE_OFF"] = "%s 끄기"
L["TYPE_SETSTATE_ON"] = "%s 켜기"
L["TYPE_SETSTATE_TOGGLE"] = "%s 전환"
L["TYPE_SETSTATE"] = "스위치 지정"
L["TYPE_SPELL"] = "주문"
