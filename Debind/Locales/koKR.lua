...
L["CUSTOM_STATE_MODE_MANUAL_INSTRUCTION"] = "여기서 스위치 값을 바꿀 수 있고, |cnBLUE_FONT_COLOR:스위치 지정|r 행동으로 언제든지(전투 중에도) 바꿀 수 있습니다."
L["CUSTOM_STATE_MODE_MANUAL"] = "직접 지정"
L["CUSTOM_STATE_NUM"] = "스위치 %d"
L["CUSTOM_STATE_OFF"] = "꺼짐"
L["CUSTOM_STATE_ON"] = "켜짐"
L["CUSTOM_STATE_REMEMBER"] = "접속할 때 마지막 값 복원"
-- 근거는 enUS 쪽 주석에.
...
L["SWITCH_RENAME_ERROR_INVALID"] = "스위치 이름은 |cnHIGHLIGHT_FONT_COLOR:$|r로 시작하고 영문자, 숫자, |cnHIGHLIGHT_FONT_COLOR:_|r만 쓸 수 있습니다."
L["SWITCH_RENAME_ERROR_TAKEN"] = "같은 이름의 스위치가 이미 있습니다."
