...
L["REJECT_ALL_IMPORT"] = "%d개 모두 버리기"
L["REJECT_ALL_IMPORT_DESC"] = "아직 기다리고 있는 것을 어디에 있든 전부 지웁니다. 받아온 문자열은 서랍에 그대로 있으니 다시 가져올 수 있습니다."
...
L["REJECT_IMPORT"] = "버리기"
L["REJECT_IMPORT_DESC"] = "이것만 지웁니다. 받아온 문자열은 서랍에 그대로 있으니 다시 가져올 수 있습니다."
...
L["IMPORT_PASTE_SOURCE"] = "누구에게 받았는지 (선택)"
L["IMPORT_PASTE_ACCEPT"] = "서랍에 넣기"
...
L["EXPORT_TITLE"] = "내보내기"
L["EXPORT_MENU_DESC"] = "설정의 일부든 전부든 문자열로 만들어 남에게 건네거나 백업으로 둘 수 있습니다.|n|n창을 열면 전부 선택되어 있고, 지금 하고 있지 않은 전문화도 목록에 들어 있습니다 - 보내려고 전문화를 바꿀 필요는 없습니다."
L["EXPORT_SELECT_ALL"] = "전체 선택"
L["EXPORT_SELECT_ALL_COUNT"] = "전체 선택 (%d)"
L["EXPORT_GENERATE"] = "문자열 만들기"
L["EXPORT_EMPTY"] = "아직 내보낼 것이 없습니다."
L["EXPORT_ROW_NO_KEY"] = "단축키 없음"
