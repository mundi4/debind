...
L["SWITCH_USED_BY_HEADER"] = "이 스위치를 쓰는 행동:"
L["SWITCH_USED_ACCOUNT"] = "계정 전체"
L["SWITCH_USED_CHARACTER"] = "현재 캐릭터"
L["SWITCH_USED_LIVE"] = "현재 활성"
L["SWITCH_MENU_INSTRUCTION"] = "오른쪽 클릭하면 설정과 이름 변경, 삭제가 나옵니다."
L["SWITCH_TURN_ON"] = "켜기"
L["SWITCH_TURN_OFF"] = "끄기"
L["SWITCH_NOT_TRACKED"] = "추적 안 함"
L["SWITCH_NOT_TRACKED_WHY"] = "이 스위치를 읽는 행동이 없어요."
...
L["SWITCH_TOGGLE_IS_AUTOMATIC"] = "매크로 조건문으로 정해지는 스위치라 눌러도 그대로 있지 않습니다."
L["SWITCH_RENAME"] = "이름 변경"
L["SWITCH_RENAME_PROMPT"] = "이 스위치를 뭐라고 부를까요?\n영문자, 숫자, |cnHIGHLIGHT_FONT_COLOR:_|r만 쓸 수 있어요."
...
L["SWITCH_DELETE_CONFIRM"] = "|cnHIGHLIGHT_FONT_COLOR:%1$s|r을(를) 지울까요?\n이 계정에서 |cnHIGHLIGHT_FONT_COLOR:%2$d|r개의 행동이 이 이름을 부릅니다. 이름은 그대로 남고, 고칠 때까지 빨간 줄이 됩니다."
L["SWITCHES_EMPTY"] = "아직 만든 스위치가 없습니다.|n|n만들면 여기 서고, 다르게 정해 둔 자리가 그 아래에 붙습니다."
L["SWITCHES_GROUP_TRACKED"] = "추적 중"
L["SWITCHES_GROUP_UNTRACKED"] = "추적 안 함"
