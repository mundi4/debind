...
L["IGNORE_HOVER_UNIT_DESC"] = "마우스 올림 조건이 켜져 있으면, 대상을 따로 정하지 않은 행동은 그 개체창의 개체에게 나갑니다. 조건이 꺼져 있으면 Hover Cast와 Mouseover Cast가 가리키고 있는 개체에게 보냅니다. 체크하면 둘 다 하지 않고, 행동은 원래 가던 곳으로 갑니다. 현재 대상이거나 자신입니다."
L["IGNORE_HOVER_UNIT"] = "가리키고 있는 개체에게 쓰지 않기"
...
L["MARK_TOOLTIP_HOVER_OVER"] = "마우스가 개체창 위에 있을 때만 실행됩니다."
L["MARK_TOOLTIP_HOVER_AWAY"] = "마우스가 개체창 위에 있지 않을 때만 실행됩니다."
...
L["ORDER_BLOCKED_UNITFRAME"] ="옆 행동을 앞지를 수 없습니다 -- 둘 중 하나만 개체창에 마우스를 올렸을 때 실행되고, 그것을 이 키에서의 순서보다 먼저 비교합니다."
