...
L["KEEP_IN_BINDING_CONTEXT_DESC"] = "The house editor takes some keys for itself while it is open, and this addon steps aside on those keys. Select this to keep the key for this action instead.|n|nThe editor still shows that key on its own buttons, so the key it displays will do nothing while you are decorating."
L["KEEP_IN_BINDING_CONTEXT"] = "Keep this key in the house editor"
