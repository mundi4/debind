...
L["MENU_SCOPE_SHARED"] = "|A:transmog-icon-warning-small:16:16|a %s -- every character on this account"
...
L["ORDER_LINE_TOOLTIP_INSTRUCTION_GOTO"] = "Left-click to go to this action."
