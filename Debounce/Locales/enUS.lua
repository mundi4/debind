...
L["DETAIL_KEY_CAPTURE_PROMPT"] = "Press a key"
L["DETAIL_NO_KEY"] = "Assign a Key"
L["DETAIL_NO_KEY_EMPTY"] = "This action has no key, so it never runs. Give it one and this is where you will see what else is on that key and who goes first."
L["DETAIL_UNBIND_KEY"] = "Unbind"
L["DETAIL_UNBIND_KEY_DESC"] = "Remove the key from this action. Everything else about it stays."
