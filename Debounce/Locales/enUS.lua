...
L["DETAIL_CHANGE_KEY"] = "Change Key"
...
L["OPTIONS"] = "Options"
L["ORDER_CANNOT_LOWER_ALREADY_LAST"] = "This action already runs last on this key."
L["ORDER_CANNOT_LOWER_BOTTOM_BAND"] = "Already at the lowest priority. The action below still runs later because it is less specific, or because its scope is broader. Change its conditions or its scope instead."
L["ORDER_CANNOT_RAISE_ALREADY_FIRST"] = "This action already runs first on this key."
L["ORDER_CANNOT_RAISE_TOP_BAND"] = "Already at the highest priority. The action above still wins because it is more specific -- it uses the hover condition or other conditions -- or because its scope is more specific. Change this action's conditions or its scope instead."
...
L["ORDER_MOVE_DOWN_DESC"] = "Lower this action's priority just enough to fall behind the action below it."
L["ORDER_MOVE_UP"] = "Run Sooner"
L["ORDER_MOVE_UP_DESC"] = "Raise this action's priority just enough to beat the action above it."
L["ORDER_PREVIEW_ONLY"] = "With this key it would be the only action."
L["ORDER_PREVIEW_POSITION"] = "With this key it would run %d of %d."
