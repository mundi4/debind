...
L["CONDITION_CUSTOM_STATES_DESC"] = "These are ON/OFF states that can be used as special conditions or macro conditional expressions in |cnLIGHTBLUE_FONT_COLOR:Custom Macros|r (Example: |cnHIGHLIGHT_FONT_COLOR:[$state1]|r). You can turn these states on or off at any time, or you can set them as macro conditionals themselves."
...
L["SPELL_PICKER_MENU_DESC"] = "Browse what you already have -- spells, macros, mounts, toys, and the game's own binding commands. The window stays open, and each click adds to whichever layer you have open."
