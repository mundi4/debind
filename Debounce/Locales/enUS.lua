...
L["CONDITION_ADD"] = "Add a Condition"
L["CONDITION_ADD_ALL_IN_USE"] = "Every condition is already in use on this action."
L["CONDITION_BONUSBAR"] = "Stance-based Action Bar"
L["CONDITION_CLEAR"] = "Remove"
L["CONDITION_CLEAR_DESC"] = "Stop limiting the action by this. Everything else about it stays."
...
L["CONDITION_EDIT_INSTRUCTION"] = "Click to change when this action runs."
...
L["CONDITION_NONE"] = "Nothing is holding this action back. It runs whenever you press its key."
...
L["DEFAULT"] = "Default"
L["DETAIL_ACTION_IS_TYPE"] = "This action is a |cnHIGHLIGHT_FONT_COLOR:%s|r."
L["DETAIL_ASSIGN_KEY"] = "Assign a Key"
L["DETAIL_CHANGE_KEY"] = "Change"
L["DETAIL_KEY_CAPTURE_HINT"] = "Press a key while the mouse is over this panel. Mouse buttons and the wheel work too."
L["DETAIL_NO_KEY"] = "No key assigned."
L["DETAIL_TAB_CONDITION"] = "Conditions"
L["DETAIL_TAB_CONTENT"] = "Content"
L["DETAIL_TAB_KEYBIND"] = "Key Binding"
...
L["ORDER_BLOCKED_CONDITIONAL_FIX"] = "An action with conditions is tried before one without, otherwise the conditional one could never run at all. To change that, edit the conditions on either action, or set a priority."
L["ORDER_BLOCKED_HOVER"] = "One of them only runs while hovering a unit frame."
L["ORDER_BLOCKED_HOVER_FIX"] = "A hover action is tried before a normal one, otherwise the normal one would always win and the hover action would never run at all. To change that, edit the hover condition on either action, or set a priority."
L["ORDER_BLOCKED_LAYER"] = "They are in different scopes."
L["ORDER_BLOCKED_LAYER_FIX"] = "The narrower scope runs first. Drag either action onto another tab to change its scope -- note that this also changes where it applies -- or set a priority. Changing the character-specific action only affects this character; changing a shared one affects every character."
L["ORDER_BLOCKED_PRIORITY"] = "They have different priorities."
L["ORDER_BLOCKED_PRIORITY_FIX"] = "Priority is decided before anything else. Click either row to set its priority directly. Changing a character-specific action only affects this character; changing a shared one affects every character, and this window cannot show you what happens on them."
...
L["ORDER_LINE_TOOLTIP_INSTRUCTION"] = "Click to set this action's priority."
...
L["ORDER_SCOPE_INACTIVE"] = "This action belongs to a scope that is not active for your current specialization, so its firing order cannot be worked out here."
L["ORDER_STATUS_ONLY"] = "This is the only action on this key."
L["ORDER_STATUS_POSITION"] = "This action runs %d of %d on this key."
L["ORDER_STATUS_UNREACHABLE"] = "This action never runs. The actions above it always win."
...
L["SORT_LIST_BY_NAME_NOTICE"] = "Sorting by name only changes how the list is drawn. It does not change which action wins a key -- that is decided by priority and conditions. Sort by key to see the real firing order."
